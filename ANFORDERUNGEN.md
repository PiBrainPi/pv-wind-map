...
| A3 | **Alle Wind- & PV-Anlagen (≥100 kW / ≥0,5 MWp)** | Alle MaStR-Anlagen der Energieträger Wind (Onshore/Offshore) — **Bruttoleistung ≥ 100 kW** — und Photovoltaik — **≥ 0,5 MWp**. Kleinere Anlagen (v. a. Dach-PV) sind bewusst ausgeschlossen. |
...
- **Anzahl (V30-Export 2026-09-08, In-Betrieb-Kern):** Wind ≥100 kW = 31.011 georef;
  PV ≥0,5 MWp (strikt ge~500) = 22.402 georef. Gesamt darstellbar (Karte) = 65.663 Anlagen
  aller Status, In-Betrieb-Kern 53.413. (Historisch 01.09.: 53.500.)
...
- **Leistungsgrenze:** nur Anlagen mit **Bruttoleistung ≥ 100 kW (Wind)** bzw. **≥ 0,5 MWp (PV)**. Kleinere Anlagen (v. a. Dach-PV) werden **nicht** importiert.
...
- ~~Leistungsgrenze~~ → **Entschieden:** ≥ 100 kW (Wind) / ≥ 0,5 MWp (PV).
