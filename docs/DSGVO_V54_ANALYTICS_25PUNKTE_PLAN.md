...
| Phase | Punkte | Status |
|---|---|---|
| **A — Recherche** | 1–7 | ⬜ offen |
| **B — Planung/Design** | 8–13 | ⬜ offen |
| **C — Umsetzung** | 14–21 | ⬜ offen |
...
- ⬜ **22. Technische Verify-Skripte (Regel 5):** ① vor Klick: **0 Network-Requests** an
...
- ⬜ **23. Rechtliche Abdeckungs-Checkliste (letzte Prüfung vor Freigabe):** Zweckbindung ✅ ·
...
- ⬜ **24. Regressions-Check Karte:** bestehende 2-Klick-OSM-Logik UNBEEINFLUSST (Kacheln
