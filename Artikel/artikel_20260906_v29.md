...
# 65.674 Wind- und PV-Anlagen auf einer Karte — was man aus dem Marktstammdatenregister wirklich herausholen kann
...
Genau diese Arbeit habe ich in ein Werkzeug gegossen. **wind-pv-map.ingenieur-tools.de** zeigt alle 65.674 Wind- und PV-Anlagen auf einer interaktiven Karte — mit Filtern, Statistiken, Netzanschlusspunkt-Analyse und einem Betroffenheits-Check. Kostenlos, ohne Login, ohne Tracking. Dieser Artikel führt durch die Funktionen und erklärt, wofür sie gut sind.

![Alle 65.674 Anlagen auf einer Karte — Cluster zeigen die Dichte](screenshots_v29/01_karte_deutschland_cluster.png)
...
Die Suche kennt Anlagennamen, Betreiber, Portfolien — und jetzt auch **Landkreise und Gemeinden**: Tippt man „Dithmarschen“ oder eine Gemeinde wie „Albersdorf“ ein, zeigt die Karte direkt alle Anlagen dieser Region, per Live-Vorschlag ab den ersten Buchstaben. Das ist der entscheidende Punkt: Tippt man einen Betreibernamen ein, bündelt die Karte **alle Anlagen aller zugehörigen Gesellschaften**. Ein Betreiber mit 15 Projektgesellschaften wird nicht zu 15 verstreuten Punkten, sondern zu einem Portfolio auf der Karte.
...
![Betreiber-Suche bündelt alle Anlagen aller Gesellschaften](screenshots_v29/02_suche_betreiber_buendelung.png)

*Abb. 2: Die Suche erkennt Betreiber über alle Einzelgesellschaften hinweg — hier: 60 Betreiber mit 184 Anlagen unter „CEE" auf einen Klick.*
...
![Gefilterte Ansicht: Brandenburg, Freiflächen-PV, 5–10 MW](screenshots_v29/03_filter_brandenburg_freiflaeche_5_10mw.png)

*Abb. 3: Beispiel-Filterung: 202 Freiflächen-PV-Anlagen zwischen 5 und 10 MW in Brandenburg. Solche Schnitte beantworten Fragestellungen wie „Wo und in welcher Größenordnung entsteht Freiflächen-PV?"*

## Statistik, die mitdenkt

Der Statistik-Bereich reicht über einfache Balken hinaus. Der **Betreiber-Tab** erkennt automatisch zusammengehörige Gesellschaften als Betreibergruppen und Portfolios — sucht man „enerparc", erscheint nicht eine zufällige Einzelgesellschaft, sondern die Gruppe mit 212 Gesellschaften und 522 Anlagen (3.218 MW). Ein Klick zeigt alle zugehörigen Anlagen auf der Karte. Die Tabelle ist sortier- und durchsuchbar.

![Betreiber-Tab mit Gruppen-Erkennung](screenshots_v29/04_statistik_betreiber_enerparc.png)

*Abb. 4: Der Betreiber-Tab gruppiert automatisch: Betreibergruppe „enerparc" mit 212 Gesellschaften, 522 Anlagen, 3.218 MW — darunter Portfolios und Einzelgesellschaften, sortierbar nach jeder Spalte.*
...
![Bundesländer-Donut](screenshots_v29/05_statistik_bundeslaender_donut.png)

*Abb. 5: 42.006 Windanlagen verteilt auf 17 Bundesländer — Niedersachsen führt mit 20,2 %, dicht gefolgt von NRW und Brandenburg. Klick auf ein Segment filtert die Karte.*
...
![Kumuliertes Wachstum Wind vs. PV](screenshots_v29/06_zubau_kumuliertes_wachstum.png)
...
![NAP-Gruppenansicht: 219 Anlagen an einem Höchstspannungsknoten](screenshots_v29/07_nap_gruppenansicht_219.png)
...
![Betroffenheits-Check: Analyse und Zusammenfassung](screenshots_v29/08_betroffenheit_summary.png)

*Abb. 8: Analyse für die Betreibergruppe „enova“ (79 Gesellschaften, 422 Anlagen), Update vom 06.09.: 58 Treffer im 20-km-Umkreis bzw. am Knoten — 7 Neuanlagen (+30,1 MW), 51 Entfernungen (−3.807,7 MW, überwiegend eine MaStR-Bereinigungswelle alter Kleinst-Windanlagen), Bestand am Knoten 1.135,6 MW, 18 von 79 Gesellschaften direkt betroffen.*
...
![Match-Tabelle: Bestand vs. Neu](screenshots_v29/09_betroffenheit_match_tabelle.png)
...
- **Vollständigkeit:** Alle 118 Felder pro Einheit werden verarbeitet, inkl. Netzanschlusspunkte: Vollabgleich über 30.948 Lokationen mit 27.898 NAPs — praktisch jeder NAP ist über die Lokation-ID an seine Anlagen gekoppelt
- **Aktualität:** Eine Pipeline aktualisiert Wind-, PV- und NAP-Daten automatisch (derzeit wöchentlich, sonntags); die Karte zeigt den Datenstand transparent an
...
**Datenquelle:** Marktstammdatenregister der Bundesnetzagentur, Datenlizenz Deutschland – Namensnennung – 2.0. Datenstand: 6. September 2026.
