...
![Alle 65.659 Anlagen auf einer Karte — Cluster zeigen die Dichte](screenshots/01_karte_deutschland_cluster.png)
...
Die Suche kennt Anlagennamen, Parks, Gemeinden — und Betreiber. Das ist der entscheidende Punkt: Tippt man einen Betreibernamen ein, bündelt die Karte **alle Anlagen aller zugehörigen Gesellschaften**. Ein Betreiber mit 15 Projektgesellschaften wird nicht zu 15 verstreuten Punkten, sondern zu einem Portfolio auf der Karte.

Jede Anlage öffnet bei Klick ein Detail-Popup mit dem vollständigen MaStR-Profil: MaStR-Nummer, Leistung (bei Wind in MW, bei PV in kWp — das Register unterscheidet nicht sauber nach AC/DC), Standort, Netzbetreiber, Spannungsebene und Inbetriebnahmedatum auf den Tag genau. Der Netzanschlusspunkt ist direkt verlinkt: Ein Klick zeigt alle anderen Anlagen am selben Knoten.

![Betreiber-Suche bündelt alle Anlagen aller Gesellschaften](screenshots/02_suche_betreiber_buendelung.png)
...
- **Typ** (Wind/PV), **Bundesland** (inkl. Offshore-AWZ), **Art** (Freifläche, Gebäude, Balkonkraftwerk, Wind an Land/auf See)
...
Jede Filterkombination zeigt sofort ein Badge mit der Anzahl passender Anlagen, die Karte folgt in Echtzeit. Die Tabelle „Alle Anlagen anzeigen" listet das Ergebnis vollständig; ein Klick auf einen Anlagennamen fliegt zur Anlage und öffnet ihr Popup, ohne die Filterauswahl zu verlieren.

![Gefilterte Ansicht: Brandenburg, Freiflächen-PV, 5–10 MW](screenshots/03_filter_brandenburg_freiflaeche_5_10mw.png)
...
Der Statistik-Bereich reicht über einfache Balken hinaus. Der **Betreiber-Tab** erkennt automatisch zusammengehörige Gesellschaften als Betreibergruppen und Portfolios — sucht man „enerparc", erscheint nicht eine zufällige Einzelgesellschaft, sondern die Gruppe mit 212 Gesellschaften und 522 Anlagen (3.217 MW). Ein Klick zeigt alle zugehörigen Anlagen auf der Karte. Die Tabelle ist sortier- und durchsuchbar.

![Betreiber-Tab mit Gruppen-Erkennung](screenshots/04_statistik_betreiber_enerparc.png)
...
![Bundesländer-Donut](screenshots/05_statistik_bundeslaender_donut.png)
...
![Kumuliertes Wachstum Wind vs. PV](screenshots/06_zubau_kumuliertes_wachstum.png)
...
![NAP-Gruppenansicht: 219 Anlagen an einem Höchstspannungsknoten](screenshots/07_nap_gruppenansicht_219.png)
...
## Der Betroffenheits-Check — für Legal, Technik und HSE

Das Herzstück für die Praxis ist der Betroffenheits-Tab. Die Fragestellung: *Was kommt auf meine Bestandsanlagen zu?*

Die Logik: Man wählt eine Referenz — eine eigene Anlage, einen eigenen Betreiber (inkl. automatisch erkannter Gruppen und Portfolios) oder einen NAP. Die Analyse prüft dann gegen die Update-Historie des MaStR, welche Anlagen **neu registriert oder neu in Betrieb** wurden, die entweder

- am **selben Netzanschlusspunkt** hängen, oder
- im wählbaren **Umkreis** (2–50 km) der Bestandsanlagen liegen.

![Betroffenheits-Check: Analyse und Zusammenfassung](screenshots/08_betroffenheit_summary.png)
...
![Match-Tabelle: Bestand vs. Neu](screenshots/09_betroffenheit_match_tabelle.png)
...
- **HSE:** Neue Windanlagen in der Nähe berühren Schattenwurf- und Eiswurf-Management, Kollisionsrisiken, elektrische Wechselwirkungen, Flächenkonkurrenz. Auch hier gilt: früh erkennen, bewerten, dokumentieren.
...
- **Vollständigkeit:** Alle 118 Felder pro Einheit werden verarbeitet, inkl. Netzanschlusspunkte: Vollabgleich über 30.628 Lokationen mit 27.870 NAPs (~99 % Abdeckung).
- **Aktualität:** Eine Pipeline aktualisiert Wind-, PV- und NAP-Daten inkrementell; die Karte zeigt den Datenstand transparent an.
